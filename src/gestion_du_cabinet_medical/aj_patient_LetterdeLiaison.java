 ...
 * @author pc
 */
public class aj_patient_LetterdeLiaison extends javax.swing.JDialog {

    /**
     * Creates new form aj_patient_LetterdeLiaison
     */
    public aj_patient_LetterdeLiaison(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
patient();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 85, 485, 359);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Ajouter ordonnance");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(160, 23, 411, 56);
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(505, 85, 328, 373);
...
String date_lettre= df.format(cal1.getTime());
  try {
...
cabinetmedical medical= new cabinetmedical();
 medical.medical_update("INSERT INTO `letterdeliaison` (`num_letter`, `date_letter`, `docteur`, `numero_rendezvous`, `patient`, `letter`) VALUES " +
"(NULL,'"+date_lettre+"', '"+jTextField1.getText()+"', "+jComboBox1.getSelectedItem()+", '"+  jTable1.getValueAt(jTable1.getSelectedRow(), 0)+"', '"+ jTextArea1.getText()+"')");
...
JOptionPane.showMessageDialog(null, "Veuillez selectionner une patient, SVP");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aj_patient_LetterdeLiaison.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                aj_patient_LetterdeLiaison dialog = new aj_patient_LetterdeLiaison(new javax.swing.JFrame(), true);
